...
// centered on the exact (mocked) GPS coordinates ems's test used. This is
// the actual point of the whole two-app flow: proving an upload on one
// app is genuinely what makes a patient visible on the other, not two
// tests independently exercising their own UI against synthetic state.
